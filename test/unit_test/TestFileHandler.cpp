...
TEST(TestFileHandler, InvalidArgument) {
	...
	Result<int, std::string> result_1 = file_handler_1.get_result();
	...
	Result<int, std::string> result_2 = file_handler_2.get_result();
	...
	Result<int, std::string> result_3 = file_handler_3.get_result();
...
TEST(TestFileHandler, InvalidExtension) {
	...
	Result<int, std::string> result_5 = file_handler_5.get_result();
...
TEST(TestFileHandler, InvalidPath) {
	...
	Result<int, std::string> result_6 = file_handler_6.get_result();
	...
	Result<int, std::string> result_7 = file_handler_7.get_result();
	...
	Result<int, std::string> result_8 = file_handler_8.get_result();
	...
	Result<int, std::string> result_9 = file_handler_9.get_result();
	...
	Result<int, std::string> result_10 = file_handler_10.get_result();
