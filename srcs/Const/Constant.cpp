...
// not support
const char ACL_METHOD[]                = "ACL";
const char BASELINE_CONTROL_METHOD[]   = "BASELINE-CONTROL";
const char BIND_METHOD[]               = "BIND";
const char CHECKIN_METHOD[]            = "CHECKIN";
const char CHECKOUT_METHOD[]           = "CHECKOUT";
const char CONNECT_METHOD[]            = "CONNECT";
const char COPY_METHOD[]               = "COPY";
const char HEAD_METHOD[]               = "HEAD";
const char LABEL_METHOD[]              = "LABEL";
const char LINK_METHOD[]               = "LINK";
const char LOCK_METHOD[]               = "LOCK";
const char MERGE_METHOD[]              = "MERGE";
const char MKACTIVITY_METHOD[]         = "MKACTIVITY";
const char MKCALENDAR_METHOD[]         = "MKCALENDAR";
const char MKCOL_METHOD[]              = "MKCOL";
const char MKREDIRECTREF_METHOD[]      = "MKREDIRECTREF";
const char MKWORKSPACE_METHOD[]        = "MKWORKSPACE";
const char MOVE_METHOD[]               = "MOVE";
const char OPTIONS_METHOD[]            = "OPTIONS";
const char ORDERPATCH_METHOD[]         = "ORDERPATCH";
const char PATCH_METHOD[]              = "PATCH";
const char PRI_METHOD[]                = "PRI";
const char PROPFIND_METHOD[]           = "PROPFIND";
const char PROPPATCH_METHOD[]          = "PROPPATCH";
const char PUT_METHOD[]                = "PUT";
const char REBIND_METHOD[]             = "REBIND";
const char REPORT_METHOD[]             = "REPORT";
const char SEARCH_METHOD[]             = "SEARCH";
const char TRACE_METHOD[]              = "TRACE";
const char UNBIND_METHOD[]             = "UNBIND";
const char UNCHECKOUT_METHOD[]         = "UNCHECKOUT";
const char UNLINK_METHOD[]             = "UNLINK";
const char UNLOCK_METHOD[]             = "UNLOCK";
const char UPDATE_METHOD[]             = "UPDATE";
const char UPDATEREDIRECTREF_METHOD[]  = "UPDATEREDIRECTREF";
const char VERSION_CONTROL_METHOD[]    = "VERSION-CONTROL";
...
std::vector<std::string> init_methods() {
    ...
    methods.push_back(std::string(ACL_METHOD));
    methods.push_back(std::string(BASELINE_CONTROL_METHOD));
    methods.push_back(std::string(BIND_METHOD));
    methods.push_back(std::string(CHECKIN_METHOD));
    methods.push_back(std::string(CHECKOUT_METHOD));
    methods.push_back(std::string(CONNECT_METHOD));
    methods.push_back(std::string(COPY_METHOD));
    methods.push_back(std::string(HEAD_METHOD));
    methods.push_back(std::string(LABEL_METHOD));
    methods.push_back(std::string(LINK_METHOD));
    methods.push_back(std::string(LOCK_METHOD));
    methods.push_back(std::string(MERGE_METHOD));
    methods.push_back(std::string(MKACTIVITY_METHOD));
    methods.push_back(std::string(MKCALENDAR_METHOD));
    methods.push_back(std::string(MKCOL_METHOD));
    methods.push_back(std::string(MKREDIRECTREF_METHOD));
    methods.push_back(std::string(MKWORKSPACE_METHOD));
    methods.push_back(std::string(MOVE_METHOD));
    methods.push_back(std::string(OPTIONS_METHOD));
    methods.push_back(std::string(ORDERPATCH_METHOD));
    methods.push_back(std::string(PATCH_METHOD));
    methods.push_back(std::string(PRI_METHOD));
    methods.push_back(std::string(PROPFIND_METHOD));
    methods.push_back(std::string(PROPPATCH_METHOD));
    methods.push_back(std::string(PUT_METHOD));
    methods.push_back(std::string(REBIND_METHOD));
    methods.push_back(std::string(REPORT_METHOD));
    methods.push_back(std::string(SEARCH_METHOD));
    methods.push_back(std::string(TRACE_METHOD));
    methods.push_back(std::string(UNBIND_METHOD));
    methods.push_back(std::string(UNCHECKOUT_METHOD));
    methods.push_back(std::string(UNLINK_METHOD));
    methods.push_back(std::string(UNLOCK_METHOD));
    methods.push_back(std::string(UPDATE_METHOD));
    methods.push_back(std::string(UPDATEREDIRECTREF_METHOD));
    methods.push_back(std::string(VERSION_CONTROL_METHOD));
	return methods;
}
