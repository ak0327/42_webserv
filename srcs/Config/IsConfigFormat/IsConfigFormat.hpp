#ifndef ISCONFIGFORMAT_HPP_
#define ISCONFIGFORMAT_HPP_
...
class IsConfigFormat
{
	...
	public:
		...
		static	bool	is_serverblock_format(const std::string &line, bool &in_server_block, bool &in_location_block, ServerConfig *serverinfs, std::string &location_path);
};
