...
{
	this->_request_keyvalue_map[key] = this->ready_ValueMap(value);
}
...
void	HttpRequest::set_content_disponesition(const std::string &key, const std::string &value)
{
	...
	this->_request_keyvalue_map[key] = this->ready_ValueMap(only_value, except_onlyvalue_line);
}
...
void	HttpRequest::set_proxy_authenticate(const std::string &key, const std::string &value)
{
	...
	this->_request_keyvalue_map[key] = this->ready_ValueMap(before_space_word, after_space_word);
}
